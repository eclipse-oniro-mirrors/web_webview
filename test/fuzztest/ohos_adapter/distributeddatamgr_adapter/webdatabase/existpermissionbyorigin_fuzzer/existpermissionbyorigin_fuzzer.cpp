...
#include "existpermissionbyorigin_fuzzer.h"
...
namespace OHOS {
    bool ExistPermissionByOriginFuzzTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::ExistPermissionByOriginFuzzTest(data, size);
    return 0;
}
