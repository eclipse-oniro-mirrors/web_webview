...
#include "releaseaudiobuffer_fuzzer.h"
...
bool ApplyReleaseAudioBufferFuzzTest(const uint8_t* data, size_t size)
{
...
{
    OHOS::ApplyReleaseAudioBufferFuzzTest(data, size);
    return 0;
}