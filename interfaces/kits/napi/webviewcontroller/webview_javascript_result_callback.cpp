...
static std::shared_ptr<JavaScriptOb> JavaScriptOb::CreateNamed(
...
static std::shared_ptr<JavaScriptOb> JavaScriptOb::CreateTransient(
...
JavaScriptOb::JavaScriptOb(napi_env env, int32_t containerScopeId, napi_value value, size_t refCount = 1)
