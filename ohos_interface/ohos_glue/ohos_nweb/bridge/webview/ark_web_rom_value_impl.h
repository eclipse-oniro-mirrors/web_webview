...
#ifndef ARK_WEB_ROM_VALUE_IMPL_H_
#define ARK_WEB_ROM_VALUE_IMPL_H_
#pragma once
...
class ArkWebRomValueImpl : public ArkWebRomValue {
    IMPLEMENT_REFCOUNTING(ArkWebRomValueImpl);

public:
    ArkWebRomValueImpl(std::shared_ptr<OHOS::NWeb::NWebRomValue> nweb_rom_value);
    ~ArkWebRomValueImpl() = default;
...
private:
    std::shared_ptr<OHOS::NWeb::NWebRomValue> nweb_rom_value_;
};

} // namespace OHOS::ArkWeb

#endif // ARK_WEB_ROM_VALUE_IMPL_H_
