...
class ArkWebLargestContentfulPaintDetailsImpl : public ArkWebLargestContentfulPaintDetails {
...
private:
    std::shared_ptr<OHOS::NWeb::NWebLargestContentfulPaintDetails> nweb_largest_contentful_paint_details_;
};
