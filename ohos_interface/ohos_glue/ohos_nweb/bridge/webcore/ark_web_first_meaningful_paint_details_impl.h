...
class ArkWebFirstMeaningfulPaintDetailsImpl : public ArkWebFirstMeaningfulPaintDetails {
    IMPLEMENT_REFCOUNTING(ArkWebFirstMeaningfulPaintDetailsImpl);

public:
    ArkWebFirstMeaningfulPaintDetailsImpl(
        std::shared_ptr<OHOS::NWeb::NWebFirstMeaningfulPaintDetails> nweb_first_meaningful_paint_details);
...
private:
    std::shared_ptr<OHOS::NWeb::NWebFirstMeaningfulPaintDetails> nweb_first_meaningful_paint_details_;
};
