...
public:
    ArkWebSelectPopupMenuItemImpl(std::shared_ptr<OHOS::NWeb::NWebSelectPopupMenuItem> nweb_select_popup_menu_item);
...
private:
    std::shared_ptr<OHOS::NWeb::NWebSelectPopupMenuItem> nweb_select_popup_menu_item_;
};
