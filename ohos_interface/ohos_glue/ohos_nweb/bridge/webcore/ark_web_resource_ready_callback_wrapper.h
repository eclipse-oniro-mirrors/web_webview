...
class ArkWebResourceReadyCallbackWrapper : public OHOS::NWeb::NWebResourceReadyCallback {
public:
    ArkWebResourceReadyCallbackWrapper(ArkWebRefPtr<ArkWebResourceReadyCallback> ark_web_resource_ready_callback);
