...
std::unique_ptr<NWeb::ScreenlockManagerAdapter> ArkOhosAdapterHelperWrapper::CreateScreenlockManagerAdapter()
{
    ArkWebRefPtr<ArkScreenlockManagerAdapter> adapter = ctocpp_->CreateScreenlockManagerAdapter();
