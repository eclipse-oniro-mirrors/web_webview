...
class ArkAudioDecoderCallbackAdapterImpl : public ArkAudioDecoderCallbackAdapter {
public:
    explicit ArkAudioDecoderCallbackAdapterImpl(std::shared_ptr<OHOS::NWeb::AudioDecoderCallbackAdapter>);
