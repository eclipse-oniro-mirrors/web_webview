...
#ifndef ARK_CAMERA_SURFACE_ADAPTER_IMPL_H
#define ARK_CAMERA_SURFACE_ADAPTER_IMPL_H
#pragma once
...
private:
    std::shared_ptr<OHOS::NWeb::CameraSurfaceAdapter> real_;

    IMPLEMENT_REFCOUNTING(ArkCameraSurfaceAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_CAMERA_SURFACE_ADAPTER_IMPL_H
