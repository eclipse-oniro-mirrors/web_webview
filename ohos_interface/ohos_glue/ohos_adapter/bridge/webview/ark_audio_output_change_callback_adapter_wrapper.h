...
#ifndef ARK_AUDIO_OUTPUT_CHANGE_CALLBACK_ADAPTER_WRAPPER_H
#define ARK_AUDIO_OUTPUT_CHANGE_CALLBACK_ADAPTER_WRAPPER_H
#pragma once
...
private:
    ArkWebRefPtr<ArkAudioOutputChangeCallbackAdapter> ctocpp_;
};

} // namespace OHOS::ArkWeb

#endif // ARK_AUDIO_OUTPUT_CHANGE_CALLBACK_ADAPTER_WRAPPER_H
