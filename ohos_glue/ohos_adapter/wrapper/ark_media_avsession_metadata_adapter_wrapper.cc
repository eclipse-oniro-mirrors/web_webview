...
#include "ark_media_avsession_metadata_adapter_wrapper.h"

namespace OHOS::ArkWeb {

ArkMediaAVSessionMetadataAdapterWrapper::ArkMediaAVSessionMetadataAdapterWrapper(
    ArkWebRefPtr<ArkMediaAVSessionMetadataAdapter> ref) : ctocpp_(ref) {}

void ArkMediaAVSessionMetadataAdapterWrapper::SetTitle(
...
void ArkMediaAVSessionMetadataAdapterWrapper::SetArtist(
...
void ArkMediaAVSessionMetadataAdapterWrapper::SetAlbum(
