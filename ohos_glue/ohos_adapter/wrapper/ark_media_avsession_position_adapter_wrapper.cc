...
#include "ark_media_avsession_position_adapter_wrapper.h"

namespace OHOS::ArkWeb {

ArkMediaAVSessionPositionAdapterWrapper::ArkMediaAVSessionPositionAdapterWrapper(
    ArkWebRefPtr<ArkMediaAVSessionPositionAdapter> ref) : ctocpp_(ref) {}

void ArkMediaAVSessionPositionAdapterWrapper::SetDuration(
    int64_t duration) {
...
void ArkMediaAVSessionPositionAdapterWrapper::SetElapsedTime(
    int64_t elapsedTime) {
...
void ArkMediaAVSessionPositionAdapterWrapper::SetUpdateTime(
    int64_t updateTime) {
