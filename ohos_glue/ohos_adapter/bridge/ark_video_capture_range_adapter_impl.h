...
#ifndef ARK_VIDEO_CAPTURE_RANGE_ADAPTER_IMPL_H
#define ARK_VIDEO_CAPTURE_RANGE_ADAPTER_IMPL_H
#pragma once
...
private:
    std::shared_ptr<OHOS::NWeb::VideoCaptureRangeAdapter> real_;

    IMPLEMENT_REFCOUNTING(ArkVideoCaptureRangeAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_VIDEO_CAPTURE_RANGE_ADAPTER_IMPL_H
