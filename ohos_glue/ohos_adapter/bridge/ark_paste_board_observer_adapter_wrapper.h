 ...
 */
#ifndef ARK_PASTEBOARD_OBSERVER_ADAPTER_WRAPPER_H
#define ARK_PASTEBOARD_OBSERVER_ADAPTER_WRAPPER_H
#pragma once
...
private:
    ArkWebRefPtr<ArkPasteBoardObserverAdapter> ctocpp_;
};

} // namespace OHOS::ArkWeb

#endif // ARK_PASTEBOARD_OBSERVER_ADAPTER_WRAPPER_H
