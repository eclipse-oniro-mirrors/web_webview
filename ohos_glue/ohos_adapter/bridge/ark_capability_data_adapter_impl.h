...
#ifndef ARK_CAPABILITY_DATA_ADAPTER_IMPL_H
#define ARK_CAPABILITY_DATA_ADAPTER_IMPL_H
#pragma once
...
private:
    std::shared_ptr<OHOS::NWeb::CapabilityDataAdapter> real_;

    IMPLEMENT_REFCOUNTING(ArkCapabilityDataAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_CAPABILITY_DATA_ADAPTER_IMPL_H
