...
#ifndef ARK_IMF_ADAPTER_FUNCTION_KEY_ADAPTER_IMPL_H
#define ARK_IMF_ADAPTER_FUNCTION_KEY_ADAPTER_IMPL_H
#pragma once
...
private:
    std::shared_ptr<OHOS::NWeb::IMFAdapterFunctionKeyAdapter> real_;

    IMPLEMENT_REFCOUNTING(ArkIMFAdapterFunctionKeyAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_IMF_ADAPTER_FUNCTION_KEY_ADAPTER_IMPL_H
