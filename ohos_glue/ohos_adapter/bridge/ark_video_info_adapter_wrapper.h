...
#ifndef ARK_VIDEO_INFO_ADAPTER_WRAPPER_H
#define ARK_VIDEO_INFO_ADAPTER_WRAPPER_H
#pragma once
...
public:
    ...
    std::shared_ptr<NWeb::VideoEncInfoAdapter> GetVideoEncInfo() override;

private:
    ArkWebRefPtr<ArkVideoInfoAdapter> ctocpp_;
};

} // namespace OHOS::ArkWeb

#endif // ARK_VIDEO_INFO_ADAPTER_WRAPPER_H
