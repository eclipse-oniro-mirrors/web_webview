...
#ifndef ARK_DATE_TIME_FORMAT_ADAPTER_IMPL_H
#define ARK_DATE_TIME_FORMAT_ADAPTER_IMPL_H
#pragma once
...
private:
    std::shared_ptr<OHOS::NWeb::DateTimeFormatAdapter> real_;

    IMPLEMENT_REFCOUNTING(ArkDateTimeFormatAdapterImpl);
};

} // namespace OHOS::ArkWeb

#endif // ARK_DATE_TIME_FORMAT_ADAPTER_IMPL_H
