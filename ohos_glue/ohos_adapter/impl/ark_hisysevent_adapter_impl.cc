...
int ArkHiSysEventAdapterImpl::Write(const ArkWebString& eventName, uint32_t type,
    const ArkWebString key1, const int64_t value1, const ArkWebString key2, const int64_t value2,
    ...
    const ArkWebString key23, const int64_t value23)
{
    ...
    std::tuple data = std::make_tuple(s_key1, value1, s_key2, value2, s_key3, value3, s_key4, value4,
        s_key5, value5, s_key6, value6, s_key7, value7, s_key8, value8, s_key9, value9, s_key10, value10,
        s_key11, value11, s_key12, value12, s_key13, value13, s_key14, value14, s_key15, value15,
        s_key16, value16, s_key17, value17, s_key18, value18, s_key19, value19, s_key20, value20,
        s_key21, value21, s_key22, value22, s_key23, value23);
    return real_.Write(s_eventName, (OHOS::NWeb::HiSysEventAdapter::EventType)type, data);
}
    ...
    const ArkWebString key7, const ArkWebString value7)
{
    ...
    std::tuple data = std::make_tuple(s_key1, s_value1, s_key2, s_value2, s_key3, s_value3, s_key4, s_value4,
                                      s_key5, s_value5, s_key6, s_value6, s_key7, s_value7);
