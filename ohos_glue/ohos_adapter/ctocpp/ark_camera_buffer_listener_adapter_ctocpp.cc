...
ARK_WEB_NO_SANITIZE
void ArkCameraBufferListenerAdapterCToCpp::OnBufferAvailable(
  ...
  // Execute
  _struct->on_buffer_available(
      _struct, ArkCameraSurfaceAdapterCppToC::Invert(surface),
      ArkCameraSurfaceBufferAdapterCppToC::Invert(buffer),
      ArkCameraRotationInfoAdapterCppToC::Invert(rotationInfo));
}
...
ArkWebBridgeType ArkWebCToCppRefCounted<
    ArkCameraBufferListenerAdapterCToCpp, ArkCameraBufferListenerAdapter,
