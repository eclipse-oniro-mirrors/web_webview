...
ARK_WEB_NO_SANITIZE
void ArkLocationCallbackAdapterCToCpp::OnLocationReport(
...
ARK_WEB_NO_SANITIZE
void ArkLocationCallbackAdapterCToCpp::OnLocatingStatusChange(
    const int status) {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
ArkWebBridgeType ArkWebCToCppRefCounted<
    ArkLocationCallbackAdapterCToCpp, ArkLocationCallbackAdapter,
