...
template<>
ArkWebBridgeType ArkWebCToCppRefCounted<ArkAudioCapturerOptionsAdapterCToCpp, ArkAudioCapturerOptionsAdapter,
    ark_audio_capturer_options_adapter_t>::kBridgeType = ARK_AUDIO_CAPTURER_OPTIONS_ADAPTER;
