...
ARK_WEB_NO_SANITIZE
void ArkScreenCaptureCallbackAdapterCToCpp::OnAudioBufferAvailable(
    bool isReady, int32_t type) {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
ARK_WEB_NO_SANITIZE
void ArkScreenCaptureCallbackAdapterCToCpp::OnVideoBufferAvailable(
    bool isReady) {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
ArkWebBridgeType ArkWebCToCppRefCounted<
    ArkScreenCaptureCallbackAdapterCToCpp, ArkScreenCaptureCallbackAdapter,
