...
ArkVideoInfoAdapterCToCpp::GetVideoCapInfo() {
  ...
  // Execute
  ark_video_capture_info_adapter_t *_retval =
      _struct->get_video_cap_info(_struct);
...
ArkVideoInfoAdapterCToCpp::GetVideoEncInfo() {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
template <>
ArkWebBridgeType
    ArkWebCToCppRefCounted<ArkVideoInfoAdapterCToCpp, ArkVideoInfoAdapter,
