...
int32_t ARK_WEB_CALLBACK ark_surface_buffer_adapter_get_file_descriptor(
...
int32_t ARK_WEB_CALLBACK ark_surface_buffer_adapter_get_width(
    struct _ark_surface_buffer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
int32_t ARK_WEB_CALLBACK ark_surface_buffer_adapter_get_height(
    struct _ark_surface_buffer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
int32_t ARK_WEB_CALLBACK ark_surface_buffer_adapter_get_stride(
    struct _ark_surface_buffer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
int32_t ARK_WEB_CALLBACK ark_surface_buffer_adapter_get_format(
    struct _ark_surface_buffer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
uint32_t ARK_WEB_CALLBACK ark_surface_buffer_adapter_get_size(
    struct _ark_surface_buffer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
void *ARK_WEB_CALLBACK ark_surface_buffer_adapter_get_vir_addr(
    struct _ark_surface_buffer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ArkWebBridgeType ArkWebCppToCRefCounted<
    ArkSurfaceBufferAdapterCppToC, ArkSurfaceBufferAdapter,
