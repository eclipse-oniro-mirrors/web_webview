    ...
    struct _ark_producer_surface_adapter_t* self, int32_t* fence, ark_buffer_request_config_adapter_t* config)
{
    ...
    ArkWebRefPtr<ArkSurfaceBufferAdapter> _retval = ArkProducerSurfaceAdapterCppToC::Get(self)->RequestBuffer(
        *fence, ArkBufferRequestConfigAdapterCToCpp::Invert(config));
    ...
    ark_surface_buffer_adapter_t* buffer, int32_t fence, ark_buffer_flush_config_adapter_t* config)
{
    ...
    return ArkProducerSurfaceAdapterCppToC::Get(self)->FlushBuffer(
        ArkSurfaceBufferAdapterCppToC::Revert(buffer), fence, ArkBufferFlushConfigAdapterCToCpp::Invert(config));
}
