...
#include "cpptoc/ark_paste_data_adapter_cpptoc.h"
...
ArkPasteRecordList ARK_WEB_CALLBACK ark_paste_data_adapter_all_records(struct _ark_paste_data_adapter_t* self)
{
    ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
