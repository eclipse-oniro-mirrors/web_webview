...
int32_t ARK_WEB_CALLBACK ark_media_codec_adapter_create_video_codec_by_mime(struct _ark_media_codec_adapter_t* self, const ArkWebString mimetype) {
  ...
  // Execute
  return ArkMediaCodecAdapterCppToC::Get(self)->CreateVideoCodecByMime(
      mimetype);
}

int32_t ARK_WEB_CALLBACK ark_media_codec_adapter_create_video_codec_by_name(struct _ark_media_codec_adapter_t* self, const ArkWebString name) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
  ...
  // Execute
  return ArkMediaCodecAdapterCppToC::Get(self)->CreateVideoCodecByName(
      name);
}

int32_t ARK_WEB_CALLBACK ark_media_codec_adapter_set_codec_callback(struct _ark_media_codec_adapter_t* self, ark_codec_callback_adapter_t* callback) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
  ...
  // Execute
  return ArkMediaCodecAdapterCppToC::Get(self)->SetCodecCallback(
      ArkCodecCallbackAdapterCToCpp::Invert(callback));
}

int32_t ARK_WEB_CALLBACK ark_media_codec_adapter_configure(struct _ark_media_codec_adapter_t* self, const ArkCodecConfigPara* config) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);

  ARK_WEB_CPPTOC_CHECK_PARAM(self,  0);

  ARK_WEB_CPPTOC_CHECK_PARAM(config,  0);


  // Execute
  return ArkMediaCodecAdapterCppToC::Get(self)->Configure(
      *config);
}
...
ark_producer_surface_adapter_t* ARK_WEB_CALLBACK ark_media_codec_adapter_create_input_surface(struct _ark_media_codec_adapter_t* self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
int32_t ARK_WEB_CALLBACK ark_media_codec_adapter_release_output_buffer(struct _ark_media_codec_adapter_t* self, uint32_t index, bool isRender) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
  ...
  // Execute
  return ArkMediaCodecAdapterCppToC::Get(self)->ReleaseOutputBuffer(
      index,
      isRender);
}
...
template<>
ArkWebBridgeType ArkWebCppToCRefCounted<ArkMediaCodecAdapterCppToC, ArkMediaCodecAdapter, ark_media_codec_adapter_t>
    ::kBridgeType = ARK_MEDIA_CODEC_ADAPTER;
