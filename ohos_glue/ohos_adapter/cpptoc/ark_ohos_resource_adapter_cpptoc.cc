...
ark_ohos_resource_adapter_get_raw_file_mapper(
  ...
  ArkWebRefPtr<ArkOhosFileMapper> _retval =
      ArkOhosResourceAdapterCppToC::Get(self)->GetRawFileMapper(*rawFile,
                                                                isSys);
...
bool ARK_WEB_CALLBACK ark_ohos_resource_adapter_is_raw_file_exist(
  ...
  // Execute
  return ArkOhosResourceAdapterCppToC::Get(self)->IsRawFileExist(*rawFile,
                                                                 isSys);
}
...
bool ARK_WEB_CALLBACK ark_ohos_resource_adapter_get_raw_file_last_mod_time1(
  ...
  // Execute
  return ArkOhosResourceAdapterCppToC::Get(self)->GetRawFileLastModTime(
      *rawFile, *date, *time, isSys);
}
...
template <>
ArkWebBridgeType
    ArkWebCppToCRefCounted<ArkOhosResourceAdapterCppToC, ArkOhosResourceAdapter,
