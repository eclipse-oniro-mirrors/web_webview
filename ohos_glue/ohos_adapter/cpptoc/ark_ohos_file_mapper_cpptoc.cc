...
ark_ohos_file_mapper_get_fd(struct _ark_ohos_file_mapper_t *self) {
...
int32_t ARK_WEB_CALLBACK
ark_ohos_file_mapper_get_offset(struct _ark_ohos_file_mapper_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ark_ohos_file_mapper_get_file_name(struct _ark_ohos_file_mapper_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ark_ohos_file_mapper_is_compressed(struct _ark_ohos_file_mapper_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ark_ohos_file_mapper_get_data_ptr(struct _ark_ohos_file_mapper_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ark_ohos_file_mapper_get_data_len(struct _ark_ohos_file_mapper_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
bool ARK_WEB_CALLBACK ark_ohos_file_mapper_unzip_data(
    struct _ark_ohos_file_mapper_t *self, uint8_t **dest, size_t *len) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
template <>
ArkWebBridgeType
    ArkWebCppToCRefCounted<ArkOhosFileMapperCppToC, ArkOhosFileMapper,
