...
ark_codec_format_adapter_get_width(struct _ark_codec_format_adapter_t *self) {
...
int32_t ARK_WEB_CALLBACK
ark_codec_format_adapter_get_height(struct _ark_codec_format_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
template <>
ArkWebBridgeType
    ArkWebCppToCRefCounted<ArkCodecFormatAdapterCppToC, ArkCodecFormatAdapter,
