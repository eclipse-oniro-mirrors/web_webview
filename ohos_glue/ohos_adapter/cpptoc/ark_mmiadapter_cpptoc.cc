...
#include "ctocpp/ark_mmiinput_listener_adapter_ctocpp.h"
#include "ctocpp/ark_mmilistener_adapter_ctocpp.h"
    ...
    struct _ark_mmiadapter_t* self, int32_t deviceId, ArkMMIDeviceInfoAdapter* info)
{
    ...
    ARK_WEB_CPPTOC_CHECK_PARAM(info, 0);

    // Execute
    return ArkMMIAdapterCppToC::Get(self)->GetDeviceInfo(deviceId, *info);
}
