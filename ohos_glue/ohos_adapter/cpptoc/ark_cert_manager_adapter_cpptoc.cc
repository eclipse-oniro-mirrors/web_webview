...
uint32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_get_cert_max_size(
...
uint32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_get_app_cert_max_size(
    struct _ark_cert_manager_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
int32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_get_sytem_root_cert_data(
  ...
  // Execute
  return ArkCertManagerAdapterCppToC::Get(self)->GetSytemRootCertData(certCount,
                                                                      certData);
}

uint32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_get_sytem_root_cert_sum(
    struct _ark_cert_manager_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
int32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_get_user_root_cert_data(
  ...
  // Execute
  return ArkCertManagerAdapterCppToC::Get(self)->GetUserRootCertData(certCount,
                                                                     certData);
}

uint32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_get_user_root_cert_sum(
    struct _ark_cert_manager_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
int32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_get_app_cert(
  ...
  // Execute
  return ArkCertManagerAdapterCppToC::Get(self)->GetAppCert(uriData, certData,
                                                            len);
}

int32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_sign(
    struct _ark_cert_manager_adapter_t *self, const uint8_t *uri,
    const uint8_t *certData, uint32_t certDataLen, uint8_t *signData,
  ...
  // Execute
  return ArkCertManagerAdapterCppToC::Get(self)->Sign(
      uri, certData, certDataLen, signData, signDataLen);
}
...
int32_t ARK_WEB_CALLBACK ark_cert_manager_adapter_get_cert_data_by_subject(
  ...
  // Execute
  return ArkCertManagerAdapterCppToC::Get(self)->GetCertDataBySubject(
      subjectName, certData, certType);
}
...
int ARK_WEB_CALLBACK ark_cert_manager_adapter_verify_cert_from_net_ssl(
  ...
  // Execute
  return ArkCertManagerAdapterCppToC::Get(self)->VerifyCertFromNetSsl(certData,
                                                                      certSize);
}
...
bool ARK_WEB_CALLBACK ark_cert_manager_adapter_get_trust_anchors_for_host_name(
  ...
  // Execute
  return ArkCertManagerAdapterCppToC::Get(self)->GetTrustAnchorsForHostName(
      *hostname, *certs);
}
...
bool ARK_WEB_CALLBACK ark_cert_manager_adapter_get_pin_set_for_host_name(
  ...
  // Execute
  return ArkCertManagerAdapterCppToC::Get(self)->GetPinSetForHostName(*hostname,
                                                                      *pins);
}
...
template <>
ArkWebBridgeType
    ArkWebCppToCRefCounted<ArkCertManagerAdapterCppToC, ArkCertManagerAdapter,
