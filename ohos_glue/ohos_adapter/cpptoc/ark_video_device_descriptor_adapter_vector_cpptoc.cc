...
#include "ark_video_device_descriptor_adapter_vector_cpptoc.h"

#include "cpptoc/ark_video_device_descriptor_adapter_cpptoc.h"
#include "impl/ark_video_device_descriptor_adapter_impl.h"
