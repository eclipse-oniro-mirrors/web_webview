...
int32_t ARK_WEB_CALLBACK ark_audio_renderer_adapter_create(
    ...
    ark_audio_renderer_options_adapter_t *options, ArkWebString *str) {
...
ark_audio_renderer_adapter_start(struct _ark_audio_renderer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
bool ARK_WEB_CALLBACK
ark_audio_renderer_adapter_pause(struct _ark_audio_renderer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
bool ARK_WEB_CALLBACK
ark_audio_renderer_adapter_stop(struct _ark_audio_renderer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
bool ARK_WEB_CALLBACK ark_audio_renderer_adapter_release2(
    struct _ark_audio_renderer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ark_audio_renderer_adapter_write(struct _ark_audio_renderer_adapter_t *self,
...
int32_t ARK_WEB_CALLBACK ark_audio_renderer_adapter_set_volume(
    struct _ark_audio_renderer_adapter_t *self, float volume) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
float ARK_WEB_CALLBACK ark_audio_renderer_adapter_get_volume(
    struct _ark_audio_renderer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
bool ARK_WEB_CALLBACK ark_audio_renderer_adapter_is_renderer_state_running(
    struct _ark_audio_renderer_adapter_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ArkAudioRendererAdapterCppToC::ArkAudioRendererAdapterCppToC() {
  ...
  GetStruct()->set_audio_renderer_callback =
      ark_audio_renderer_adapter_set_audio_renderer_callback;
  GetStruct()->set_interrupt_mode =
      ark_audio_renderer_adapter_set_interrupt_mode;
  GetStruct()->is_renderer_state_running =
...
ArkWebBridgeType ArkWebCppToCRefCounted<
    ArkAudioRendererAdapterCppToC, ArkAudioRendererAdapter,
