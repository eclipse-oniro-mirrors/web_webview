...
ark_ohos_web_permission_data_base_adapter_exist_permission_by_origin(
  ...
  // Execute
  return ArkOhosWebPermissionDataBaseAdapterCppToC::Get(self)
      ->ExistPermissionByOrigin(*origin, *key);
}
...
ark_ohos_web_permission_data_base_adapter_get_permission_result_by_origin(
  ...
  // Execute
  return ArkOhosWebPermissionDataBaseAdapterCppToC::Get(self)
      ->GetPermissionResultByOrigin(*origin, *key, *result);
}
...
ark_ohos_web_permission_data_base_adapter_set_permission_by_origin(
  ...
  // Execute
  ArkOhosWebPermissionDataBaseAdapterCppToC::Get(self)->SetPermissionByOrigin(
      *origin, *key, result);
}
...
ark_ohos_web_permission_data_base_adapter_clear_permission_by_origin(
  ...
  // Execute
  ArkOhosWebPermissionDataBaseAdapterCppToC::Get(self)->ClearPermissionByOrigin(
      *origin, *key);
}
...
ark_ohos_web_permission_data_base_adapter_clear_all_permission(
  ...
  // Execute
  ArkOhosWebPermissionDataBaseAdapterCppToC::Get(self)->ClearAllPermission(
      *key);
}
...
ark_ohos_web_permission_data_base_adapter_get_origins_by_permission(
  ...
  // Execute
  ArkOhosWebPermissionDataBaseAdapterCppToC::Get(self)->GetOriginsByPermission(
      *key, *origins);
}
...
ArkOhosWebPermissionDataBaseAdapterCppToC::
  ...
  GetStruct()->clear_permission_by_origin =
      ark_ohos_web_permission_data_base_adapter_clear_permission_by_origin;
  GetStruct()->clear_all_permission =
      ark_ohos_web_permission_data_base_adapter_clear_all_permission;
