...
#ifndef ARK_MEDIA_CODEC_DECODER_ADAPTER_CAPI_H
#define ARK_MEDIA_CODEC_DECODER_ADAPTER_CAPI_H
#pragma once
...
typedef struct _ark_decoder_callback_adapter_t {
    ...
    void(ARK_WEB_CALLBACK* on_stream_changed)(
        struct _ark_decoder_callback_adapter_t* self, const ArkDecoderFormat* format);

    void(ARK_WEB_CALLBACK* on_need_input_data)(
        struct _ark_decoder_callback_adapter_t* self, uint32_t index, ArkOhosBuffer buffer);

    void(ARK_WEB_CALLBACK* on_need_output_data)(
        struct _ark_decoder_callback_adapter_t* self, uint32_t index, ArkBufferInfo info, uint32_t flag);
...
#endif // ARK_MEDIA_CODEC_DECODER_ADAPTER_CAPI_H
