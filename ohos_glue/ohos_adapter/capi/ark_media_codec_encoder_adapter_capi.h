...
typedef struct _ark_codec_callback_adapter_t {
  ...
  void (ARK_WEB_CALLBACK *on_stream_changed)(struct _ark_codec_callback_adapter_t* self, const ArkCodecFormatAdapter* format);

  void (ARK_WEB_CALLBACK *on_need_input_data)(struct _ark_codec_callback_adapter_t* self, uint32_t index, ArkOhosBuffer buffer);

  void (ARK_WEB_CALLBACK *on_need_output_data)(struct _ark_codec_callback_adapter_t* self, uint32_t index, ArkBufferInfo info, int32_t flag, ArkOhosBuffer buffer);
...
typedef struct _ark_media_codec_adapter_t {
  ...
  int32_t (ARK_WEB_CALLBACK *create_video_codec_by_mime)(struct _ark_media_codec_adapter_t* self, const ArkWebString mimetype);

  int32_t (ARK_WEB_CALLBACK *create_video_codec_by_name)(struct _ark_media_codec_adapter_t* self, const ArkWebString name);

  int32_t (ARK_WEB_CALLBACK *set_codec_callback)(struct _ark_media_codec_adapter_t* self, ark_codec_callback_adapter_t* callback);
  ...
  int32_t (ARK_WEB_CALLBACK *release_output_buffer)(struct _ark_media_codec_adapter_t* self, uint32_t index, bool isRender);
...
typedef struct _ark_media_codec_list_adapter_t {
  ...
  ArkCapabilityDataAdapter (ARK_WEB_CALLBACK *get_codec_capability)(struct _ark_media_codec_list_adapter_t* self, const ArkWebString mime, const bool isCodec);
