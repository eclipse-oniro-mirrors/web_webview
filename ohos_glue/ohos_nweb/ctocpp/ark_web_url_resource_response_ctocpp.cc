...
ArkWebString ArkWebUrlResourceResponseCToCpp::ResponseData() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, response_data,
...
ARK_WEB_NO_SANITIZE
void ArkWebUrlResourceResponseCToCpp::PutResponseData(
...
ArkWebString ArkWebUrlResourceResponseCToCpp::ResponseStatus() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, response_status,
                                   ark_web_string_default);
...
const ArkWebStringMap ArkWebUrlResourceResponseCToCpp::ResponseHeaders() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, response_headers,
...
ARK_WEB_NO_SANITIZE
void ArkWebUrlResourceResponseCToCpp::PutResponseHeaders(
...
ArkWebString ArkWebUrlResourceResponseCToCpp::ResponseMimeType() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, response_mime_type,
                                   ark_web_string_default);
...
ARK_WEB_NO_SANITIZE
void ArkWebUrlResourceResponseCToCpp::PutResponseMimeType(
...
ArkWebString ArkWebUrlResourceResponseCToCpp::ResponseEncoding() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, response_encoding,
                                   ark_web_string_default);
...
ARK_WEB_NO_SANITIZE
void ArkWebUrlResourceResponseCToCpp::PutResponseEncoding(
...
ARK_WEB_NO_SANITIZE
void ArkWebUrlResourceResponseCToCpp::PutResponseDataStatus(
    bool is_data_ready) {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
ArkWebString ArkWebUrlResourceResponseCToCpp::ResponseResourceUrl() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, response_resource_url,
                                   ark_web_string_default);
...
ARK_WEB_NO_SANITIZE
void ArkWebUrlResourceResponseCToCpp::PutResponseResourceUrl(
...
ARK_WEB_NO_SANITIZE
void ArkWebUrlResourceResponseCToCpp::PutResponseStateAndStatuscode(
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct,
                                   put_response_state_and_statuscode, );

  // Execute
  _struct->put_response_state_and_statuscode(_struct, status_code,
                                             &reason_phrase);
}

ARK_WEB_NO_SANITIZE
void ArkWebUrlResourceResponseCToCpp::PutResponseReadyCallback(
  ...
  // Execute
  _struct->put_response_ready_callback(
...
ArkWebBridgeType ArkWebCToCppRefCounted<
    ArkWebUrlResourceResponseCToCpp, ArkWebUrlResourceResponse,
