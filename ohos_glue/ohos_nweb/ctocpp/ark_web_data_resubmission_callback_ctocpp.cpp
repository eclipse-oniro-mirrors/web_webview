...
template<>
ArkWebBridgeType ArkWebCToCppRefCounted<ArkWebDataResubmissionCallbackCToCpp, ArkWebDataResubmissionCallback,
    ark_web_data_resubmission_callback_t>::kBridgeType = ARK_WEB_DATA_RESUBMISSION_CALLBACK;
