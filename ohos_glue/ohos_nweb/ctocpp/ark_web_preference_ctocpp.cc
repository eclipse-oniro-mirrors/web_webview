...
ArkWebString ArkWebPreferenceCToCpp::DefaultUserAgent() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, default_user_agent,
...
ArkWebString ArkWebPreferenceCToCpp::FixedFontFamilyName() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, fixed_font_family_name,
                                   ark_web_string_default);
...
ArkWebString ArkWebPreferenceCToCpp::SerifFontFamilyName() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, serif_font_family_name,
                                   ark_web_string_default);
...
ArkWebString ArkWebPreferenceCToCpp::CursiveFontFamilyName() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, cursive_font_family_name,
                                   ark_web_string_default);
...
ARK_WEB_NO_SANITIZE
void ArkWebPreferenceCToCpp::PutCursiveFontFamilyName(
...
ArkWebString ArkWebPreferenceCToCpp::FantasyFontFamilyName() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, fantasy_font_family_name,
                                   ark_web_string_default);
...
ARK_WEB_NO_SANITIZE
void ArkWebPreferenceCToCpp::PutFantasyFontFamilyName(
    const ArkWebString &font) {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
bool ArkWebPreferenceCToCpp::GetMediaPlayGestureAccess() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_media_play_gesture_access,
                                   false);
...
ArkWebString ArkWebPreferenceCToCpp::StandardFontFamilyName() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, standard_font_family_name,
                                   ark_web_string_default);
...
ARK_WEB_NO_SANITIZE
void ArkWebPreferenceCToCpp::PutStandardFontFamilyName(
    const ArkWebString &font) {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
ArkWebString ArkWebPreferenceCToCpp::SansSerifFontFamilyName() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, sans_serif_font_family_name,
                                   ark_web_string_default);
...
ARK_WEB_NO_SANITIZE
void ArkWebPreferenceCToCpp::PutSansSerifFontFamilyName(
    const ArkWebString &font) {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
bool ArkWebPreferenceCToCpp::IsVerticalScrollBarAccess() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, is_vertical_scroll_bar_access,
                                   false);
...
bool ArkWebPreferenceCToCpp::IsHorizontalScrollBarAccess() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, is_horizontal_scroll_bar_access,
                                   false);
...
void ArkWebPreferenceCToCpp::PutLogicalFontSizeLowerLimit(int size) {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct,
                                   put_logical_font_size_lower_limit, );
...
ArkWebString ArkWebPreferenceCToCpp::DefaultTextEncodingFormat() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, default_text_encoding_format,
                                   ark_web_string_default);
...
ARK_WEB_NO_SANITIZE
void ArkWebPreferenceCToCpp::PutDefaultTextEncodingFormat(
...
bool ArkWebPreferenceCToCpp::IsLoadImageFromNetworkDisabled() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, is_load_image_from_network_disabled,
                                   false);
...
void ArkWebPreferenceCToCpp::PutLoadImageFromNetworkDisabled(bool flag) {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct,
                                   put_load_image_from_network_disabled, );
...
bool ArkWebPreferenceCToCpp::EnableRawFileAccessFromFileURLs() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(
      _struct, enable_raw_file_access_from_file_urls, false);
...
void ArkWebPreferenceCToCpp::PutEnableRawFileAccessFromFileURLs(bool flag) {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct,
                                   put_enable_raw_file_access_from_file_urls, );
...
bool ArkWebPreferenceCToCpp::EnableUniversalAccessFromFileURLs() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(
      _struct, enable_universal_access_from_file_urls, false);
...
void ArkWebPreferenceCToCpp::PutEnableUniversalAccessFromFileURLs(bool flag) {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(
      _struct, put_enable_universal_access_from_file_urls, );
...
bool ArkWebPreferenceCToCpp::IsCreateWindowsByJavaScriptAllowed() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(
      _struct, is_create_windows_by_java_script_allowed, false);
...
void ArkWebPreferenceCToCpp::PutIsCreateWindowsByJavaScriptAllowed(bool flag) {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(
      _struct, put_is_create_windows_by_java_script_allowed, );
...
int ArkWebPreferenceCToCpp::AccessModeForSecureOriginLoadFromInsecure() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(
      _struct, access_mode_for_secure_origin_load_from_insecure, 0);
...
ARK_WEB_NO_SANITIZE
void ArkWebPreferenceCToCpp::PutAccessModeForSecureOriginLoadFromInsecure(
    int mode) {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(
      _struct, put_access_mode_for_secure_origin_load_from_insecure, );
...
template <>
ArkWebBridgeType
    ArkWebCToCppRefCounted<ArkWebPreferenceCToCpp, ArkWebPreference,
