...
ARK_WEB_NO_SANITIZE
void ArkWebSelectPopupMenuCallbackCToCpp::Continue(const ArkWebInt32Vector& indices)
{
    ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
...
template<>
ArkWebBridgeType ArkWebCToCppRefCounted<ArkWebSelectPopupMenuCallbackCToCpp, ArkWebSelectPopupMenuCallback,
    ark_web_select_popup_menu_callback_t>::kBridgeType = ARK_WEB_SELECT_POPUP_MENU_CALLBACK;
