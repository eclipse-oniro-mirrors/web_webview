...
ArkWebString ArkWebMediaInfoCToCpp::GetPosterUrl() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_poster_url,
                                   ark_web_string_default);
...
ArkWebStringVector ArkWebMediaInfoCToCpp::GetControls() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_controls,
...
ArkWebStringMap ArkWebMediaInfoCToCpp::GetHeaders() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_headers,
...
ArkWebStringMap ArkWebMediaInfoCToCpp::GetAttributes() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_attributes,
                                   ark_web_string_map_default);
...
ArkWebMediaSourceInfoVector ArkWebMediaInfoCToCpp::GetSourceInfos() {
  ...
  ARK_WEB_CTOCPP_CHECK_FUNC_MEMBER(_struct, get_source_infos,
                                   ark_web_media_source_info_vector_default);
...
ArkWebMediaInfoCToCpp::GetSurfaceInfo() {
  ARK_WEB_CTOCPP_DV_LOG("capi struct is %{public}ld", (long)this);
  ...
  // Execute
  ark_web_native_media_player_surface_info_t *_retval =
      _struct->get_surface_info(_struct);
...
template <>
ArkWebBridgeType ArkWebCToCppRefCounted<ArkWebMediaInfoCToCpp, ArkWebMediaInfo,
