...
ArkWebString ARK_WEB_CALLBACK ark_web_js_proxy_callback_get_method_name(
...
NativeArkWebOnJavaScriptProxyCallback ARK_WEB_CALLBACK
...
template <>
ArkWebBridgeType
    ArkWebCppToCRefCounted<ArkWebJsProxyCallbackCppToC, ArkWebJsProxyCallback,
