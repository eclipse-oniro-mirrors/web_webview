...
ark_web_drag_event_get_x(struct _ark_web_drag_event_t *self) {
...
double ARK_WEB_CALLBACK
ark_web_drag_event_get_y(struct _ark_web_drag_event_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ark_web_drag_event_get_action(struct _ark_web_drag_event_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
template <>
ArkWebBridgeType ArkWebCppToCRefCounted<ArkWebDragEventCppToC, ArkWebDragEvent,
