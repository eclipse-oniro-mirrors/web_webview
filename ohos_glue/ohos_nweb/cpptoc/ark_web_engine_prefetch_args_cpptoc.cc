...
ArkWebString ARK_WEB_CALLBACK ark_web_engine_prefetch_args_get_url(
...
ArkWebString ARK_WEB_CALLBACK ark_web_engine_prefetch_args_get_method(
    struct _ark_web_engine_prefetch_args_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ArkWebString ARK_WEB_CALLBACK ark_web_engine_prefetch_args_get_form_data(
    struct _ark_web_engine_prefetch_args_t *self) {
  ARK_WEB_CPPTOC_DV_LOG("capi struct is %{public}ld", (long)self);
...
ArkWebBridgeType ArkWebCppToCRefCounted<
    ArkWebEnginePrefetchArgsCppToC, ArkWebEnginePrefetchArgs,
