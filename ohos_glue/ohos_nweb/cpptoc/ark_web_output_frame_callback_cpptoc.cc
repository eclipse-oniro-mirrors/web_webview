...
bool ARK_WEB_CALLBACK ark_web_output_frame_callback_handle(
    struct _ark_web_output_frame_callback_t *self, const char *buffer,
  ...
  // Execute
  return ArkWebOutputFrameCallbackCppToC::Get(self)->Handle(buffer, width,
                                                            height);
}
...
ArkWebBridgeType ArkWebCppToCRefCounted<
    ArkWebOutputFrameCallbackCppToC, ArkWebOutputFrameCallback,
