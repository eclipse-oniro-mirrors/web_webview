...
ArkWebNativeEmbedStatus ArkWebNativeEmbedDataInfoWrapper::GetStatus() {
  return static_cast<ArkWebNativeEmbedStatus>(
      ark_web_native_embed_data_info_->GetStatus());
}
...
ArkWebNativeEmbedDataInfoWrapper::GetNativeEmbedInfo() {
  ...
  return std::make_shared<ArkWebNativeEmbedInfoWrapper>(
