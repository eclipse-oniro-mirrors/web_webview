...
ArkWebImageOptionsWrapper::ArkWebImageOptionsWrapper(
...
ArkWebImageAlphaType ArkWebImageOptionsWrapper::GetAlphaType() {
  return static_cast<ArkWebImageAlphaType>(
      ark_web_image_options_->GetAlphaType());
}

ArkWebImageColorType ArkWebImageOptionsWrapper::GetColorType() {
  return static_cast<ArkWebImageColorType>(
      ark_web_image_options_->GetColorType());
}
