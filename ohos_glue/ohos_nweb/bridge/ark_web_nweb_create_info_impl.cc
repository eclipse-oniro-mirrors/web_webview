...
ArkWebNWebCreateInfoImpl::ArkWebNWebCreateInfoImpl(
...
ArkWebNWebCreateInfoImpl::GetEngineInitArgs() {
  std::shared_ptr<OHOS::NWeb::NWebEngineInitArgs> nweb_engine_init_args =
      nweb_create_info_->GetEngineInitArgs();
...
ArkWebNWebCreateInfoImpl::GetOutputFrameCallback() {
  std::shared_ptr<OHOS::NWeb::NWebOutputFrameCallback>
      nweb_output_frame_callback = nweb_create_info_->GetOutputFrameCallback();
