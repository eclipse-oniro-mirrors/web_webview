...
ArkWebJsResultCallbackImpl::ArkWebJsResultCallbackImpl(
    std::shared_ptr<OHOS::NWeb::NWebJavaScriptResultCallBack>
        nweb_js_result_callback)
    : nweb_js_result_callback_(nweb_js_result_callback) {
}

ArkWebValue ArkWebJsResultCallbackImpl::GetJavaScriptResult(
  ...
  ark_web_value.nweb_value = nweb_js_result_callback_->GetJavaScriptResult(
      ArkWebValueVectorStructToClass(args), ArkWebStringStructToClass(method),
      ArkWebStringStructToClass(object_name), routing_id, object_id);
...
bool ArkWebJsResultCallbackImpl::HasJavaScriptObjectMethods(
  ...
  return nweb_js_result_callback_->HasJavaScriptObjectMethods(
      object_id, ArkWebStringStructToClass(method_name));
}

ArkWebValue
ArkWebJsResultCallbackImpl::GetJavaScriptObjectMethods(int32_t object_id) {
  ArkWebValue ark_web_value;
  ark_web_value.nweb_value =
      nweb_js_result_callback_->GetJavaScriptObjectMethods(object_id);
  return ark_web_value;
}

void ArkWebJsResultCallbackImpl::RemoveJavaScriptObjectHolder(
