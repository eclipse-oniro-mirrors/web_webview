...
ArkWebDateTimeChooserType ArkWebDateTimeChooserWrapper::GetType() {
  return static_cast<ArkWebDateTimeChooserType>(
      ark_web_date_time_chooser_->GetType());
}
...
OHOS::NWeb::DateTime ArkWebDateTimeChooserWrapper::GetDialogValue() {
  return ArkWebDateTimeStructToClass(
      ark_web_date_time_chooser_->GetDialogValue());
}
