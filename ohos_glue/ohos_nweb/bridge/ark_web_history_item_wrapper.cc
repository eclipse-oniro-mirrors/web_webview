...
ArkWebHistoryItemWrapper::ArkWebHistoryItemWrapper(
    ArkWebRefPtr<ArkWebHistoryItem> ark_web_history_item)
    : ark_web_history_item_(ark_web_history_item) {
}

bool ArkWebHistoryItemWrapper::GetFavicon(void **data, int &width, int &height,
  ...
  bool result = ark_web_history_item_->GetFavicon(
