...
void ArkWebWebStorageOriginVectorValueCallbackImpl::OnReceiveValue(
    const ArkWebWebStorageOriginVector &value) {
  nweb_web_storage_origin_vector_value_callback_->OnReceiveValue(
      ArkWebWebStorageOriginVectorStructToClass(value));
}
