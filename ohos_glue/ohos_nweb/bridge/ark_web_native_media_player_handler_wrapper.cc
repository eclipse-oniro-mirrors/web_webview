...
void ArkWebNativeMediaPlayerHandlerWrapper::HandleStatusChanged(
    ArkWebPlaybackStatus status) {
  ark_web_native_media_player_handler_->HandleStatusChanged(
...
void ArkWebNativeMediaPlayerHandlerWrapper::HandlePlaybackRateChanged(
    double playbackRate) {
  ark_web_native_media_player_handler_->HandlePlaybackRateChanged(playbackRate);
}

void ArkWebNativeMediaPlayerHandlerWrapper::HandleDurationChanged(
    double duration) {
...
void ArkWebNativeMediaPlayerHandlerWrapper::HandleBufferedEndTimeChanged(
    double bufferedEndTime) {
  ark_web_native_media_player_handler_->HandleBufferedEndTimeChanged(
      bufferedEndTime);
}
...
void ArkWebNativeMediaPlayerHandlerWrapper::HandleNetworkStateChanged(
    ArkWebNetworkState state) {
  ark_web_native_media_player_handler_->HandleNetworkStateChanged(
      static_cast<int>(state));
}

void ArkWebNativeMediaPlayerHandlerWrapper::HandleReadyStateChanged(
    ArkWebReadyState state) {
  ark_web_native_media_player_handler_->HandleReadyStateChanged(
      static_cast<int>(state));
}

void ArkWebNativeMediaPlayerHandlerWrapper::HandleFullScreenChanged(
    bool isFullScreen) {
...
void ArkWebNativeMediaPlayerHandlerWrapper::HandleError(
    ArkWebMediaError error, const std::string &message) {
  ArkWebString stMessage = ArkWebStringClassToStruct(message);

  ark_web_native_media_player_handler_->HandleError(static_cast<int>(error),
                                                    stMessage);

  ArkWebStringStructRelease(stMessage);
}

void ArkWebNativeMediaPlayerHandlerWrapper::HandleVideoSizeChanged(
