...
ArkWebMediaInfoWrapper::ArkWebMediaInfoWrapper(
    ArkWebRefPtr<ArkWebMediaInfo> ark_web_media_info)
...
std::vector<std::string> ArkWebMediaInfoWrapper::GetControls() {
  ...
  std::vector<std::string> objControls =
      ArkWebStringVectorStructToClass(stControls);
...
std::map<std::string, std::string> ArkWebMediaInfoWrapper::GetAttributes() {
  ...
  std::map<std::string, std::string> objAttributes =
      ArkWebStringMapStructToClass(stAttributes);
  ArkWebStringMapStructRelease(stAttributes);
  return objAttributes;
}

std::vector<std::shared_ptr<OHOS::NWeb::NWebMediaSourceInfo>>
ArkWebMediaInfoWrapper::GetSourceInfos() {
  ArkWebMediaSourceInfoVector stMediaSourceInfoVector =
      ark_web_media_info_->GetSourceInfos();

  std::vector<std::shared_ptr<OHOS::NWeb::NWebMediaSourceInfo>>
      objMediaSourceInfoVector =
...
ArkWebMediaInfoWrapper::GetSurfaceInfo() {
  ...
  return std::make_shared<ArkWebNativeMediaPlayerSurfaceInfoWrapper>(
      ark_web_native_media_player_surface_info);
}
