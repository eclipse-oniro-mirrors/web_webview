...
NWebSelectPopupMenuItemType ArkWebSelectPopupMenuItemWrapper::GetType() {
  return static_cast<NWebSelectPopupMenuItemType>(
      ark_web_select_popup_menu_item_->GetType());
}
...
NWebTextDirection ArkWebSelectPopupMenuItemWrapper::GetTextDirection() {
  return static_cast<NWebTextDirection>(
      ark_web_select_popup_menu_item_->GetTextDirection());
}
